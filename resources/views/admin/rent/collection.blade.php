                    ...
                    <div class="card-body">
                        <form action="<?php echo url("make-payment"); ?>" method="post">
                            <div class="row">
                                ...
                                <?php foreach ($data as $dt) { ?>
                                    <div class="col-md-4"><input type="checkbox" id="rent[]" name="rent[]" class="rentbox" value="Rent~<?php echo $dt->amount; ?>~<?php echo $dt->id; ?>~<?php echo $dt->rent_no; ?>~<?php echo $dt->tds ?>~<?php echo $dt->gst ?>">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 form-group">
                                    ...
                                    <input type="text" name="netgst" id="netgst" class="form-control">
                                    <input type="text" name="nettds" id="nettds" class="form-control">
                                </div>
    ...
    $(document).ready(function() {
        ...
        $(".rentbox").click(function() {
            if ($(this).is(':checked')) {
                ...
                tds = parseFloat(tds) + parseFloat(sval[4]);
                gst = parseFloat(gst) + parseFloat(sval[5]);
                $("#total").val(total);
                $("#netgst").val(gst);
                $("#nettds").val(tds);
                $("#balance").val(0);
