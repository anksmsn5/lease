...
<div class="content-wrapper">
                    ...
                    <form class="forms-sample" action="<?php echo url("update-property");?>/<?php echo $property->id;?>" method="post">
                      ...
                      <div class="form-group col-md-6">
                        <label for="exampleInputUsername1">Property Type</label>
                         <select name="property_type" class="form-control">
							...
							{?>
                            <option value="<?php echo $tp->id?>" <?php if($property->property_type==$tp->id){ echo "selected";}?>><?php echo $tp->property_type?></option>
                            <?php } ?>
                         </select>
                      </div>
                      <div class="form-group col-md-6">
                      ...
                      <div class="form-group col-md-6">
                        <label for="exampleInputPassword1">Property For</label>
                         <select name="type" class="form-control">
                            <option value="">Select</option>
                            <option value="Rental" <?php if($property->type=='Rental'){ echo "selected";}?>>Rental</option>
                            <option value="Sale" <?php if($property->type=='Sale'){ echo "selected";}?>>Sale</option>
                            <option value="Lease" <?php if($property->type=='Lease'){ echo "selected";}?>>Lease</option>
                         </select>
                      </div>
                      <div class="form-group col-md-6">
                      ...
                      <div class="form-group col-md-6">
                       ...
                       <select name="availability_status" class="form-control">
                        <option value="">Select</option>
                        <option value="Available" <?php if($property->availability_status=='Available'){ echo "selected";}?>>Available</option>
                        <option value="Not Available" <?php if($property->availability_status=='Not Available'){ echo "selected";}?>>Not Available</option>
                       </select>
 ...
 <div class="form-group col-md-3">
                       ...
                       <select name="furnishing_status" class="form-control">
                        <option value="">Select</option>
                        <option value="Furnished" <?php if($property->furnishing=='Furnished'){ echo "selected";}?>>Furnished</option>
                        <option value="Semi Furnished" <?php if($property->furnishing=='Semi Furnished'){ echo "selected";}?>>Semi Furnished</option>
                        <option value="Un Furnished" <?php if($property->furnishing=='Un Furnished'){ echo "selected";}?>>Un Furnished</option>
                       </select>
