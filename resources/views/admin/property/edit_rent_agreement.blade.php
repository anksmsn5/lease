  ...
  <strong>Success!</strong> <?php echo session('success');?>
                      ...
                      <div class="form-group col-md-6">
                        <label for="exampleInputUsername1">Property Type</label>
                         <select name="property_type" id="property_type" class="form-control select2" required>
							...
							{?>
                            <option value="<?php echo $tp->id?>" <?php if($agreement->property_type==$tp->id){ echo "selected";}?>><?php echo $tp->property_type?></option>
                            <?php } ?>
                         </select>
                      </div>
                      <div class="form-group col-md-6">
                        ...
                        <select name="property" id="property" class="form-control  select2" onchange="getPropertyData(this.value)">
								...
								{?>
                                <option value="<?php echo $prop->id; ?>" <?php if($prop->id==$property->id){ echo "selected";}?>>(<?php echo $prop->property_id; ?>) <?php echo $prop->property_name; ?>, <?php echo $prop->address; ?></option>
								<?php } ?>
                        </select>
        ...
        ';?>
                       ...
                       <div class="form-group col-md-4">
                        <label for="exampleInputConfirmPassword1">Country</label>
                         <select name="country" id="country" class="form-control" required>
                                ...
                                {?>
                                <option value="<?php echo $cont->id?>" <?php if($tenant->country==$cont->id){ echo "selected";}?>><?php echo $cont->country?></option>
                                <?php } ?>
                         </select>
                      </div>
                       ...
                       <div class="form-group col-md-4">
                        <label for="exampleInputConfirmPassword1">State</label>
                         <select name="state" id="state" class="form-control" onchange="getCities(this.value)" required>
                                ...
                                {?>
                                <option value="<?php echo $cont->id?>" <?php if($tenant->state==$cont->id){ echo "selected";}?>><?php echo $cont->state?></option>
                                <?php } ?>
                         </select>
                      </div>
                       ...
                       <div class="form-group col-md-4">
                        <label for="exampleInputConfirmPassword1">City</label>
                         <select name="city" id="city" class="form-control" required>
                                ...
                                {?>
                                <option value="<?php echo $cont->id?>" <?php if($tenant->city==$cont->id){ echo "selected";}?>><?php echo $cont->city?></option>
                                <?php } ?>
                         </select>
                      </div>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control" id="maintenance_amount" name="maintenance_amount" placeholder="" required value="<?php echo $agreement->rent_amount?>">
                       ...
                       <select name="fit_out" class="form-control">
							<option value="">Select</option>
							<option value="30" <?php if($agreement->fit_out=='30'){ echo "selected";}?>>30</option>
							<option value="45" <?php if($agreement->fit_out=='45'){ echo "selected";}?>>45</option>
							<option value="60" <?php if($agreement->fit_out=='60'){ echo "selected";}?>>60</option>
							<option value="90" <?php if($agreement->fit_out=='90'){ echo "selected";}?>>90</option>
					   </select>
                       ...
                       <select name="escalation" class="form-control">
							<option value="">Select</option>
							<option value="5" <?php if($agreement->escalation=='5'){ echo "selected";}?>>5</option>
							<option value="7.5" <?php if($agreement->escalation=='7.5'){ echo "selected";}?>>7.5</option>
							<option value="10" <?php if($agreement->escalation=='10'){ echo "selected";}?>>10</option>
 ...
 <?php    $tenant_responsibility=explode(", ",$agreement->tenant_responsibility);?>
                    <div class="form-group col-md-12">
                        <label for="exampleInputConfirmPassword1">Tenant's Responsibility</label>
						 ...
						 {?>
						 <option value="<?php echo $res->responsibility?>" <?php if(in_array($res->responsibility,$tenant_responsibility)){ echo "selected";}?>><?php echo $res->responsibility?></option>
						 <?php } ?>
						 </select>
                      </div>
                      ...
                      <div class="form-group col-md-12">
						...
						<?php foreach($responsibilities as $res)
						 {?>
						 <option value="<?php echo $res->responsibility?>" <?php if(in_array($res->responsibility,$owner_responsibility)){ echo "selected";}?>><?php echo $res->responsibility?></option>
						 <?php } ?>
						 </select>
                      </div>
					...
					<div class="form-group col-md-6">
                     ...
                     <select name="stamp_duty_paid" class="form-control">
							<option value="">Select</option>
							<option value="Yes" <?php if($agreement->stamp_duty_paid=='Yes'){ echo "selected";}?>>Yes</option>
							<option value="No" <?php if($agreement->stamp_duty_paid=='No'){ echo "selected";}?>>No</option>
